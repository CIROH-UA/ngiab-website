    ...
    <section className="bg-gray-900" id="team">
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
        <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
          ...
          <p className="font-light sm:text-xl text-gray-400">Meet our dedicated team of experts working together to transform hydrologic modeling</p>
        </div>
        ...
        <div className={`grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 transition-all duration-300 ease-in-out ${
          ...
          {displayedMembers.map((member, index) => (
            <div 
              key={index} 
              className="text-center text-gray-400 transform transition-all duration-300 ease-in-out"
            >
              ...
              <ul className="flex justify-center mt-4 space-x-4">
                {member.github && (
                  <li>
                    <a href={member.github} className="hover:text-white text-gray-300 transition-colors duration-300">
                ...
                {member.linkedin && (
                  <li>
                    <a href={member.linkedin} className="hover:text-white text-gray-300 transition-colors duration-300">
                ...
                {member.email && (
                  <li>
                    <a href={`mailto:${member.email}`} className="hover:text-white text-gray-300 transition-colors duration-300">
